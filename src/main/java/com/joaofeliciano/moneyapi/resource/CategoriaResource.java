...
import com.joaofeliciano.moneyapi.repository.CategoriaRepository;
...
public class CategoriaResource {
	...
	public ResponseEntity<Categoria> criar(@Valid @RequestBody Categoria categoria, HttpServletResponse httpServletResponse) {
		...
		publisher.publishEvent(new RecursoCriadoEvent(this, httpServletResponse, categoriaSalva.getCodigo()));
